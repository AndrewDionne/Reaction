# Written Exam Visual Training Patch v1.52.0

## Scope

This patch turns written exam mode into a diagram/graph/calculation training mode. The question text stays in the app and the image acts as the source diagram.
