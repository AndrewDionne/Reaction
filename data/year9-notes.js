  ...
  "unitOverviews": [
    {
      ...
      "visualTiles": [
        ...
        },
        {
          ...
          "alt": "Full-width DNA hierarchy diagram showing cell, nucleus, chromosome, DNA and gene.",
          "mediaTitle": "DNA, chromosomes and genes",
          "mediaLead": "Use this full-width hierarchy to link cell, nucleus, chromosome, DNA and gene."
        },
        {
      ...
      "visualTiles": [
        {
          ...
          "alt": "Annotated light-intensity graph showing the limiting-factor pattern in photosynthesis.",
          "mediaTitle": "Photosynthesis limiting-factor graphs",
          "mediaLead": "Describe the trend, then explain why the line levels off when another factor becomes limiting."
        },
        {
    ...
    },
    {
      ...
      "infographicBacklog": [],
      "leadMedia": {
        "src": "assets/webp/9E-structure-of-materials-overview.webp",
    ...
    },
    {
      ...
      "visualTiles": [
        ...
        {
          "src": "assets/webp/9J-circuit-symbols-overview.webp",
          "alt": "Full-width circuit symbol grid showing common electrical components.",
          "mediaTitle": "Circuit symbols grid",
          "mediaLead": "Use this full-width grid to identify cells, batteries, switches, lamps, motors, resistors and meters."
        },
        {
          "src": "assets/webp/9J-current-voltage-overview.webp",
          "alt": "Full-width current-voltage graph comparing two resistors with different resistance.",
          "mediaTitle": "Current-voltage graphs",
          "mediaLead": "For the same voltage, the steeper line shows the lower resistance."
        },
        {
        ...
        },
        {
          ...
          "alt": "Full-width comparison of gravitational, magnetic and electric fields.",
  ...
  "notes": [
    {
      "id": "9A-variation",
      "unit": "9A",
      "objective": "9A-variation",
      "title": "Variation and classification",
      "summary": "Variation means differences in characteristics between individuals. Some variation is inherited through genes, some is caused by the environment, and many characteristics are affected by both.",
      "keyPoints": [
    ...
    },
    {
      "id": "9A-inheritance",
      "unit": "9A",
      "objective": "9A-inheritance",
      "title": "Inheritance, DNA and genes",
      "summary": "Genetic information is stored in DNA. DNA is packaged into chromosomes inside the nucleus of cells. A gene is a short section of DNA that helps control a characteristic.",
      "keyPoints": [
    ...
    },
    {
      "id": "9A-biodiversity",
      "unit": "9A",
      "objective": "9A-biodiversity",
      "title": "Biodiversity, conservation and extinction",
      "summary": "Biodiversity is the variety of living organisms in an area. Conservation tries to protect species, habitats and genetic information so that organisms are less likely to become extinct.",
      "keyPoints": [
        "A species is endangered when it is at risk of extinction.",
        "Extinction can be caused by habitat loss, new predators, disease, climate change, pollution or competition.",
        "Gene banks can store seeds, sperm, eggs or DNA to preserve genetic variation.",
    ...
    },
    {
      "id": "9A-evolution",
      "unit": "9A",
      "objective": "9A-evolution",
      "title": "Adaptation, natural selection and evolution",
      "summary": "Adaptations are features that help an organism survive or reproduce. Natural selection means individuals with helpful inherited characteristics are more likely to survive, reproduce and pass on their genes.",
      "keyPoints": [
    ...
    },
    {
      ...
      "unit": "9B",
      "objective": "9B-photosynthesis",
      "title": "Photosynthesis and respiration",
      "summary": "Photosynthesis is the process plants use to make glucose. It needs carbon dioxide and water, uses light energy captured by chlorophyll, and produces glucose and oxygen.",
      "keyPoints": [
    ...
    },
    {
      ...
      "unit": "9B",
      "objective": "9B-plant-transport",
      "title": "Plant transport and specialised cells",
      "summary": "Plants have specialised cells and tissues to get water, minerals and gases to the cells that need them. Root hair cells absorb water and minerals, xylem carries water upward, phloem carries dissolved sugars, and stomata control gas exchange.",
      "keyPoints": [
    ...
    },
    {
      ...
      "unit": "9B",
      "objective": "9B-plant-products",
      "title": "Plant products, seeds and food production",
      "summary": "Plants use glucose from photosynthesis to make useful substances such as starch, cellulose, oils and proteins. Farmers can increase yield by improving growing conditions.",
      "keyPoints": [
    ...
    },
    {
      "id": "9B-food-webs",
      "unit": "9B",
      "objective": "9B-food-webs",
      "title": "Food webs, biodiversity and ecosystems",
      "summary": "Food webs show feeding relationships and energy transfer. Changes to one population can affect other organisms, and farming choices can change biodiversity.",
      "keyPoints": [
        "Arrows in food webs show the direction of energy transfer.",
        "If prey numbers fall, predator numbers may also fall.",
        "Persistent pesticides can build up through food chains.",
    ...
    },
    {
      "id": "9E-ceramics",
      "unit": "9E",
      "objective": "9E-ceramics",
      "title": "Ceramics, crystals and materials properties",
      "summary": "Ceramics are materials such as pottery, china, bricks and glass. They are often hard, heat resistant and have high melting points, but many are brittle.",
      "keyPoints": [
    ...
    },
    {
      "id": "9E-polymers",
      "unit": "9E",
      "objective": "9E-polymers",
      "title": "Polymers and polymerisation",
      "summary": "Polymers are long-chain molecules made from many repeating units. They can be natural, such as cellulose, or synthetic, such as many plastics.",
      "keyPoints": [
    ...
    },
    {
      "id": "9E-composites",
      "unit": "9E",
      "objective": "9E-composites",
      "title": "Composites and material choice",
      "summary": "Composite materials are made by combining two or more materials so the final material has useful properties from each part.",
      "keyPoints": [
        "Concrete is a composite because it contains cement, sand and gravel.",
        "Reinforced concrete combines concrete with steel reinforcement.",
        "Glass-reinforced plastic combines plastic with glass fibres.",
    ...
    },
    {
      "id": "9E-environment",
      "unit": "9E",
      "objective": "9E-environment",
      "title": "Environmental impacts and recycling",
      "summary": "Making and disposing of materials can cause environmental problems, including landfill, pollution, acid rain and greenhouse gas emissions. Recycling and reducing fossil-fuel use can reduce impacts.",
      "keyPoints": [
    ...
    },
    {
      "id": "9F-changes",
      "unit": "9F",
      "objective": "9F-changes",
      "title": "Physical and chemical changes",
      "summary": "Physical changes do not make new substances, while chemical reactions produce new substances. Particle ideas help explain gases, pressure and formulae.",
      "keyPoints": [
    ...
    },
    {
      "id": "9F-reactivity",
      "unit": "9F",
      "objective": "9F-reactivity",
      "title": "Reactivity and displacement",
      "summary": "The reactivity series ranks metals by how readily they react. More reactive metals can displace less reactive metals from compounds.",
      "keyPoints": [
    ...
    },
    {
      "id": "9F-extraction",
      "unit": "9F",
      "objective": "9F-extraction",
      "title": "Metal extraction and reduction",
      "summary": "Metals are extracted from ores. The extraction method depends on reactivity: less reactive metals can often be extracted using carbon, while very reactive metals need electrolysis.",
      "keyPoints": [
    ...
    },
    {
      "id": "9F-rusting",
      "unit": "9F",
      "objective": "9F-rusting",
      "title": "Rusting and corrosion protection",
      "summary": "Rusting is corrosion of iron or steel. It needs oxygen and water. It can be prevented by coatings or by sacrificial protection.",
      "keyPoints": [
        "Rusting needs both oxygen and water.",
        "Paint, oil, grease or plastic coatings keep oxygen and water away.",
        "Galvanising coats steel with zinc.",
    ...
    },
    {
      ...
      "summary": "Forces can change motion. Drag forces such as air resistance and water resistance oppose motion. Terminal velocity happens when forces become balanced.",
      "keyPoints": [
    ...
    },
    {
      "id": "9I-energy-work",
      "unit": "9I",
      "objective": "9I-energy-work",
      "title": "Energy, work and simple machines",
      "summary": "Work is done when a force moves an object through a distance. Simple machines can reduce the force needed, but they usually increase the distance moved and do not reduce the total energy needed.",
      "keyPoints": [
        "Work done = force × distance.",
        "A ramp reduces the force needed but increases distance.",
        "Friction wastes energy as heating.",
    ...
    },
    {
      ...
      "summary": "Speed tells us how fast something moves. Mean speed is total distance divided by total time. Distance-time graphs show how distance changes with time.",
      "keyPoints": [
        "Speed = distance ÷ time.",
        "Mean speed uses total distance and total time.",
    ...
    },
    {
      ...
      "summary": "A moment is the turning effect of a force around a pivot. The size of a moment depends on the force and the perpendicular distance from the pivot.",
      "keyPoints": [
        "Moment = force × distance from pivot.",
        "The pivot of a lever is also called the fulcrum.",
        "A longer effort arm gives a larger moment for the same force.",
        "An object balances when clockwise and anticlockwise moments are equal."
      ],
      "commonMistakes": [
        {
    ...
    },
    {
      ...
      "summary": "A force field is a region where an object experiences a non-contact force. Gravitational, magnetic and electric fields are examples.",
      "keyPoints": [
    ...
    },
    {
      ...
      "summary": "Static electricity is the build-up of charge on an object. In solids, electrons can transfer between insulating materials, making objects negatively or positively charged.",
      "keyPoints": [
        "Electrons are negatively charged.",
        "An object gains electrons and becomes negatively charged.",
        "An object loses electrons and becomes positively charged.",
    ...
    },
    {
      "id": "9J-circuits",
      "unit": "9J",
      "objective": "9J-circuits",
      "title": "Current, voltage and circuits",
      "summary": "Current is the rate of flow of charge. Voltage, or potential difference, is the energy transferred per unit charge. Circuits can be series or parallel.",
      "keyPoints": [
    ...
    },
    {
      "id": "9J-resistance",
      "unit": "9J",
      "objective": "9J-resistance",
      "title": "Resistance and Ohm’s law",
      "summary": "Resistance tells us how difficult it is for current to flow. Ohm’s law links voltage, current and resistance.",
      "keyPoints": [
        "Resistance = voltage ÷ current.",
    ...
    },
    {
      ...
      "unit": "9J",
      "objective": "9J-electromagnets",
      "title": "Electromagnets, relays and motors",
      "summary": "An electromagnet is made when current flows through a coil, often around an iron core. Electromagnets can be switched on and off and are used in relays and motors.",
      "keyPoints": [
        "More turns on the coil make an electromagnet stronger.",
